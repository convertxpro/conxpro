                      ...
                      <div className="truncate">
                        <div className="flex items-center gap-2">
                          ...
                          {tool.pakistanSpecific && (
                            <span className="shrink-0 rounded-full bg-emerald-100 px-1.5 py-0.2 text-[10px] font-semibold text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
                              🇵🇰 Pakistan
                            </span>
                          )}
                          {tool.badge && !tool.pakistanSpecific && (
